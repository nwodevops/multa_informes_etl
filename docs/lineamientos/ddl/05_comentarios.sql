...
COMMENT ON COLUMN MI_FACT_MULTA_COERCITIVA.ID_FUENTE IS 'FK a MI_DIM_FUENTE_REGISTRO; alinea a FUENTE_REGISTRO.';
...
COMMENT ON COLUMN MI_FACT_MULTA_COERCITIVA.FUENTE_REGISTRO IS 'Código degenerado de fuente (igual a MI_DIM_FUENTE_REGISTRO.CODIGO): OD_SHEETS, CAGR, GAPPS o SISUD_VW.';
...
COMMENT ON COLUMN MI_DET_ETAPA_MC.FUENTE_REGISTRO IS 'Fuente origen; valor fijo CAGR (degenerada, igual a CODIGO de la dim).';
