...
COMMENT ON COLUMN MI_FACT_MULTA_COERCITIVA.ID_OD IS 'FK a MI_DIM_OD (territorio F1); -1 si la fila no viene de Excel OD.';
...
COMMENT ON COLUMN MI_FACT_MULTA_COERCITIVA.FUENTE_REGISTRO IS 'Fuente origen: OD_SHEETS, CAGR, GAPPS o SISUD_VW (OD_EXCEL legacy).';
