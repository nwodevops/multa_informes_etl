...
**Reporte:** wf_main terminó OK; log muestra `DW_M_INDICADOR_RESULTADO: 585 -> 585 (OK)` pero usuario ve tabla vacía.
...
APP.DW_M_INDICADOR_RESULTADO: 585 filas
APP.DW_M_FACT_MULTA_COERCITIVA: 571 filas
...
```sql
SELECT COUNT(*) FROM APP.DW_M_INDICADOR_RESULTADO;
SELECT COD_INDICADOR, COUNT(*) FROM APP.DW_M_INDICADOR_RESULTADO GROUP BY COD_INDICADOR;
```
...
DW: POST-CARGA APP.DW_M_INDICADOR_RESULTADO = 585 filas (esperado 585)
DW: indicadores presentes: K1, K2, K3, K4, K5
```

## Cierre (2026-08-19 21:57)

- [x] wf_main OK: POST-CARGA APP.DW_M_INDICADOR_RESULTADO = 585, K1–K5.
