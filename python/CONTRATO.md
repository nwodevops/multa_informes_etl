...
CAPA POST-STAGING (lineamientos Fases 2–7)
  ...
  python/io/cargar_dw.py    SALIDA: TRUNCATE+INSERT DIM_*/FACT_*/DET_*/DQ_*/INDICADOR_RESULTADO → Oracle BD_CURSOR
```
...
| `DQ_HALLAZGO` / `QA_AMARRE` | 4 | Calidad + amarre H9 |
| `DIM_*` | 5 | Dimensiones con miembro `-1` |
| `FACT_*` / `DET_ETAPA_MC` | 5 | Hechos y detalle |
| `INDICADOR_RESULTADO` | 7 | KPIs K1–K5 |
