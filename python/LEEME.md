...
| **Post-staging** | Después de que Hop cargó `STG_*` | `main.py` | `python/io/` + `logica/` (raíz) | Lee H2, transforma, carga Oracle + enrich 07 | Introspectar fuentes, crear STG |
...
main.py      →  io/leer_h2     →  ../logica/*.py  →  io/cargar_dw (wipe+DDL+INSERT+07)
```
