        ...
        rows.append(
            {
                ...
                "F_VERIF_CAMPO": r.get("F_VERIF_CAMPO"),
                ...
                "N_CARTA_DCG": r.get("N_CARTA_DCG"),
                "MOTIVO_NO_AMERIT": r.get("MOTIVO_NO_AMERIT"),
                "MEDIDA_ADMINISTRATIVA": r.get("MEDIDA_ADMINISTRATIVA"),
                "MEMO_EF": r.get("MEMO_EF"),
                "SIGED": r.get("SIGED"),
                "DOC_SIGED_DESCARGOS": r.get("DOC_SIGED_DESCARGOS"),
                "DOC_VERIF_MC": r.get("DOC_VERIF_MC"),
                "MONTO_UIT": muit,
                "MONTO_UIT_SISUD": None,
                "N_RES_SISUD": None,
