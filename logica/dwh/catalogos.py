...
Aquí viven las EQUIVALENCIAS estáticas que el resto del código consulta:
  - DW_M_DIM_ESTADO / MAPEO_ESTADO  → homologación de estados (H8)
  - DW_M_DIM_PARAMETRO_UIT          → UIT por año (MONTO_S_CALC y R05)
  - ODS_OEFA                      → semilla DW_M_DIM_OD
...
# Semillas DW_M_DIM_ESTADO: (TIPO_ESTADO, CODIGO, DESCRIPCION, GRUPO)
DW_M_DIM_ESTADO: list[tuple[str, str, str, str]] = [
...
DW_M_DIM_PARAMETRO_UIT: dict[int, float] = {
    2015: 3850.0,
    2016: 3950.0,
    2017: 4050.0,
    2018: 4150.0,
